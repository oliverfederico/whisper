...
common_voice["train"] = load_dataset("mozilla-foundation/common_voice_11_0", "hi", split="train[:10]+validation[:10]")#, use_auth_token=True)
common_voice["test"] = load_dataset("mozilla-foundation/common_voice_11_0", "hi", split="test[:10]")#, use_auth_token=True)
...
pipe = pipeline(model="./whisper-base-hi")  # change to "your-username/the-name-you-picked"
